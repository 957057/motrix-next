export default {
  ...
  'engine-cleanup-warning': 'Membersihkan status mesin akan menghapus data kelanjutan tugas yang belum selesai.\nPengaturan, file unduhan, dan riwayat tetap disimpan.',
  'engine-cleanup-retry': 'Bersihkan dan Coba Lagi',
