export default {
  ...
  'engine-cleanup-warning': 'Η εκκαθάριση της κατάστασης του μηχανισμού αφαιρεί τα δεδομένα συνέχισης των ημιτελών εργασιών.\nΟι ρυθμίσεις, τα ληφθέντα αρχεία και το ιστορικό διατηρούνται.',
  'engine-cleanup-retry': 'Εκκαθάριση και νέα προσπάθεια',
