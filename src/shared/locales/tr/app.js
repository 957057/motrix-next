export default {
  ...
  'engine-cleanup-warning': 'Motor durumunu temizlemek, tamamlanmamış görevlerin devam kayıtlarını kaldırır.\nAyarlar, indirilen dosyalar ve geçmiş korunur.',
  'engine-cleanup-retry': 'Temizle ve Yeniden Dene',
