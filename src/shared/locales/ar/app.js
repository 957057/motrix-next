export default {
  ...
  'engine-cleanup-warning': 'سيؤدي تنظيف حالة المحرك إلى إزالة سجلات استئناف المهام غير المكتملة.\nستبقى الإعدادات والملفات المنزلة والسجل محفوظة.',
  'engine-cleanup-retry': 'تنظيف الحالة وإعادة المحاولة',
