export default {
  ...
  'engine-cleanup-warning': 'Очищення стану рушія видалить дані відновлення незавершених завдань.\nНалаштування, завантажені файли та історія збережуться.',
  'engine-cleanup-retry': 'Очистити й повторити',
