export default {
  ...
  'engine-cleanup-warning': 'Очистка состояния движка удалит данные возобновления незавершённых задач.\nНастройки, загруженные файлы и история сохранятся.',
  'engine-cleanup-retry': 'Очистить и повторить',
