export default {
  ...
  'engine-ready': 'Il motore Aria2 Next è pronto',
  ...
  'quit-app': 'Esci',
  'engine-crashed': 'Il motore di download Aria2 Next si e disconnesso',
  'engine-recovering': 'Riavvio del motore di download Aria2 Next in corso...',
  'engine-unrecoverable': 'Impossibile ripristinare il motore di download Aria2 Next',
  'engine-attempt': 'Tentativi',
  'engine-manual-retry': 'Riprova manualmente',
  'engine-stage-stop': 'Arresto del vecchio processo',
  'engine-stage-start': 'Avvio del motore',
  'engine-stage-verify': 'Verifica della connessione',
  'engine-last-error': 'Ultimo errore',
  'engine-cleanup-warning':
    'La reimpostazione dello stato del motore elimina i dati di sessione delle attività incomplete.\nImpostazioni, file scaricati e cronologia non vengono modificati.',
  'engine-reset-state': 'Reimposta stato del motore',
  'engine-cleaning': 'Pulizia dello stato del motore',
  'engine-cleaning-description': 'Le impostazioni dell’app e i file scaricati verranno mantenuti.',
  'engine-recovered-description': 'Il servizio di download è nuovamente connesso.',
  ...
  'speedometer-needs-config':
    'Configura un limite tramite menu contestuale o preferenze (almeno uno deve essere superiore a 0)',
