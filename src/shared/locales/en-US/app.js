export default {
  ...
  'engine-cleanup-warning': 'Cleaning engine state removes resume records for unfinished tasks.\nSettings, downloaded files, and history are preserved.',
  'engine-cleanup-retry': 'Clean State and Retry',
