export default {
  ...
  'engine-cleanup-warning': 'پاک‌سازی وضعیت موتور، اطلاعات ادامهٔ کارهای ناتمام را حذف می‌کند.\nتنظیمات، فایل‌های دانلودشده و تاریخچه حفظ می‌شوند.',
  'engine-cleanup-retry': 'پاک‌سازی و تلاش دوباره',
